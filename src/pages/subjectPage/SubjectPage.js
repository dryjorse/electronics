          ...
          <div className={s.title}>
            ...
            {sbj.image && (
              <div className={s.picture}>
                <img src={sbj.image.content} alt="main-image" />
                {sbj.image.description && (
                  <span>
                    Рис. <strong>{sbj.image.description.number}.</strong>{" "}
                    {sbj.image.description.title}
                  </span>
                )}
              </div>
            )}
          </div>
          {sbj.subtopics?.map((sbt, key) => (
                ...
                if (cont.type === "text" || !notStringTypes.includes(cont.type))
                  ...
                  return (
                    <div className={s.picture} key={key}>
                      ...
                      <span>
                        Рис. <strong>{cont.description.number}.</strong>{" "}
                        {cont.description.title}
                      </span>
                    </div>
                  );
              })}
